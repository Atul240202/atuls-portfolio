      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          <ul>
            ...
            <br></br>
            <li className="about-activity">
              <ImPointRight /> Grand Finalist at Toycathon Digial Edition(Initiative by Central
Government under Aatma Nirbhar Bhara abhiyan)
            </li>
            <br></br>

            <li className="about-activity">
              <ImPointRight /> 3rd rank in FireQuest hosted by Google Developers Group, Chandigarh
            </li>
            <br></br>

            <li className="about-activity">
              <ImPointRight /> Outstanding Student Volunteer Award from IEEE Delhi Section
            </li>
            <br></br>
            ...
            <li className="about-activity">
              <ImPointRight /> Award for exemplary Leadership skills from Executive Director of
