        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I am an Enthusiast, with passion to learn new skills & implement them in real time to solve some problem. 
              Because thats what a Engineer do 🤷‍♂️
              <br />
              ...
              <i>
                <b className="purple">Web Technologies </b> as its give me an opportunity to showcase my creativity
              </i>
              <br />
